...
const Register = () => {
  ...
  useEffect(() => {
    //validates whether the password is valid or not and then checks match password and password same or not
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(Note);
      axios.post("https://webspirebackend.onrender.com/register", Note, { Unique: true });
      setSuccess(true);
      setUser("");
      setPwd("");
      setMatchPwd("");
